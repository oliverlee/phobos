 ...
 */
constexpr float MAX_KISTLER_TORQUE_POSITIVE = -4.29314f; // maximum measured steer torque, N-m
constexpr adcsample_t KISTLER_ADC_ZERO_OFFSET_POSITIVE = 2046; // ADC value for zero torque, found experimentally
constexpr float MAX_KISTLER_TORQUE_NEGATIVE = -4.32969f; // maximum measured steer torque, N-m
constexpr adcsample_t KISTLER_ADC_ZERO_OFFSET_NEGATIVE = 2047; // ADC value for zero torque, found experimentally
 ...
 */
constexpr float UPPER_ASSEMBLY_INERTIA = 0.03185004118699606; // kg-m^2
constexpr float LOWER_ASSEMBLY_INERTIA = 0.010860690708980467; // kg-m^2
constexpr float ASSEMBLY_INERTIA = UPPER_ASSEMBLY_INERTIA + LOWER_ASSEMBLY_INERTIA;
